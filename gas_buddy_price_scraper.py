...
if __name__ == "__main__":
    ...
    def get_cash_prices(url):
        # print("NEW STATION")
        headers = {
            'User-Agent': 'Mozilla/5.0 (compatible; Anonymous/1.0)'
        }
    ...
    station_data = [
        {'url': 'https://www.gasbuddy.com/station/*stationNumber*', 'nickname': 'Nickname', 'location': 'LocationName'},
        {'url': 'https://www.gasbuddy.com/station/*stationNumber*', 'nickname': 'Nickname', 'location': 'LocationName'},
        {'url': 'https://www.gasbuddy.com/station/*stationNumber*', 'nickname': 'Nickname', 'location': 'LocationName'},
    ...
    if os.path.exists(file_path):
        ...
        new_df.to_csv(file_path, mode='w', header=True, index=False)  # mode = 'a' and header = False to append data
    ...
    def send_email(subject, body, to_emails):
        ...
        smtp_user = 'email@server.com'  # Replace with your email address
        smtp_password = '*your smtp password*'  # Replace with your email password
    ...
    # Recipients list
    recipients = ['email1@server.com']  # Replace with your recipient list
